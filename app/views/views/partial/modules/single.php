<div id="content">
	<div class="row-fluid">
		<div class="box" style="margin-top:0; min-width:500px;">
			<div class="box-header" data-original-title="">
				<h3><i class="fa-icon-check"></i><span class="break"></span><?=$q->title;?></h3>
			</div>
			<div class="box-content" style="overflow-x:scroll; overflow-y:hidden;">

<div class="single-container <?php echo ($q->passage_array) ? 'ext' : ''; ?>" style="margin:0 auto;">
	...
	<div id="single-wrapper" class="single-wrapper">
		...
		<div class="answer-container">
			...
			<?php
			if ($q->xml):
				foreach($q->xml->example->element as $num) {  foreach($num->attributes() as $k => $v) { var_dump(array($k, (string)$v)); } }
			endif;
			?>
		</div>
	</div>
